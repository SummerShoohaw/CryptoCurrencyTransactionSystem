 ...
 * @author lm
 */
public class SellingRequest  extends Request{
    public SellingRequest(Customer cus, int price, Organization org, String coinType, double amount, int num){
        super(cus, price, org, coinType, amount, num, "sell");
    }
